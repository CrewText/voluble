...
export namespace ContactManager {
     ...
     */
    export function createContact(first_name: string, surname: string, email: string, phone_num: string, default_servicechain: string, org_id?: string): Promise<ContactInstance> {
